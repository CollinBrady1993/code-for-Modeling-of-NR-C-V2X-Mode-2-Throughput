To obtain the base vestion of the code to patch you must request access (see https://5g-lena.cttc.es/download/) to the NR V2X software 
then install folloing the directions here: https://gitlab.com/cttc-lena/nr/-/blob/5g-lena-v2x-v0.1.y/README.md
...
titled "Modeling-of-NR-C-V2X-Mode-2-Throughput-Simulation.cc", is in contrib/nr/examples/nr-v2x-examples and connot be run without enabling them.